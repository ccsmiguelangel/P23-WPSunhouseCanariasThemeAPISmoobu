...
<script type="text/javascript">
  /* <![CDATA[ */
  var nd_booking_my_vars_sorting;
  /* ]]> */
</script>
...
<style type="text/css">
  ...
  .nd_options_customizer_fonts
    .nd_options_placeholder_color_greydark_important::-webkit-input-placeholder {
    color: #525252 !important;
  }
  .nd_options_customizer_fonts
    .nd_options_placeholder_color_greydark_important::-moz-placeholder {
    color: #525252 !important;
  }
  .nd_options_customizer_fonts
    .nd_options_placeholder_color_greydark_important:-ms-input-placeholder {
    color: #525252 !important;
  }
  .nd_options_customizer_fonts
    .nd_options_placeholder_color_greydark_important:-moz-placeholder {
...
<style type="text/css" id="wp-custom-css">
  ...
  /*WOO POST GRID*/
  .nd_options_postgrid_woo_component_l4
...
<form id="nd_booking_search_cpt_1_form_sidebar">
  ...
  >
    <!--branches-->
    <div
      id="nd_booking_search_cpt_1_form_branches"
      class="nd_booking_display_none nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_15 nd_booking_padding_0_responsive nd_booking_box_sizing_border_box"
    >
      <!-- <select
      class="nd_booking_width_100_percentage nd_booking_bg_greydark_2_important nd_booking_border_width_0_important nd_options_color_white nd_options_first_font nd_booking_font_size_20 nd_booking_text_align_center"
      onchange="nd_booking_sorting(1)"
      name="nd_booking_archive_form_branches"
      id="nd_booking_archive_form_branches"
    > -->
      <select
        class="nd_booking_width_100_percentage nd_booking_bg_greydark_2_important nd_booking_border_width_0_important nd_options_color_white nd_options_first_font nd_booking_font_size_20 nd_booking_text_align_center"
        name="nd_booking_archive_form_branches"
      ...
      >
        ...
        <option value="217">Hotel Rome</option>
        <option value="214">Hotel Berlin</option>
        <option value="207">Hotel New York</option>
        <option value="54">Hotel London</option>
      </select>
    </div>
    <!--branches-->
  ...
  <!--max night range-->
  <div
    id="nd_booking_search_cpt_1_form_night_range"
    class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box"
  >
    <div class="nd_booking_section nd_booking_height_20"></div>
    <div
      class="nd_booking_section nd_booking_height_2 nd_booking_bg_grey"
    ></div>

    <div
      class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box"
    >
      <div class="nd_booking_section">
        <h3 class="nd_booking_float_left">Precio Por Noche :</h3>
        <span
          class="nd_booking_float_right nd_options_first_font nd_options_color_greydark nd_booking_line_height_25 nd_booking_font_size_20"
          >$</span
        >
        <input
          class="nd_booking_float_right nd_options_first_font nd_booking_margin_right_5 nd_booking_border_width_0_important"
          type="text"
          id="nd_booking_archive_form_max_price_for_day"
          name="nd_booking_archive_form_max_price_for_day"
          readonly=""
        />
      </div>
  ...
  <!--normal service-->
  <div
    id="nd_booking_search_cpt_1_form_normal_services"
    class="nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box"
  >
    <div
      class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box"
    >
      <h3>Servicios :</h3>
      <img
        class="nd_booking_toogle_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
        alt=""
        width="12"
        src="<?php echo get_stylesheet_directory_uri().'/public/icons/icon-down-arrow-grey.svg';?>"
        style="display: none"
      />
      <img
        style="transform: rotate(180deg); display: block"
        class="nd_booking_toogle_services_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer"
        alt=""
        width="12"
        src="<?php echo get_stylesheet_directory_uri().'/public/icons/icon-down-arrow-grey.svg';?>"
      />
    ...
    <div
      class="nd_booking_toogle_services_content nd_booking_padding_0_30 nd_booking_section nd_booking_display_none nd_booking_margin_top_10_negative nd_booking_box_sizing_border_box"
      style="display: block"
    >
    <?php 
    $args_services = array(
    ...
    if ( $taxonomies_servicios ) {
      foreach (  $taxonomies_servicios as $taxonomy ) {
        echo '
        <p
        class="nd_booking_width_50_percentage nd_booking_width_100_percentage_all_iphone nd_booking_float_left nd_booking_margin_0"
        >
          <input
            class="nd_booking_checkbox_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8"
            name="nd_booking_service_id_'.$taxonomy->term_id.'"
            type="checkbox"
    ...
    <input
      type="hidden"
      id="nd_booking_archive_form_services"
      name="nd_booking_archive_form_services"
      value=""
    />
      ...
      jQuery(document).ready(function () {
        jQuery(function ($) {
          ...
          $(".nd_booking_toogle_services_open_content").click(function () {
            $(".nd_booking_toogle_services_content").slideToggle(
              "slow",
              function () {
                $(".nd_booking_toogle_services_open_content").css(
                  "display",
                  "none"
                );
                $(".nd_booking_toogle_services_close_content").css(
                  "display",
                  "block"
                );
              }
  ...
  <div id="nd_booking_search_cpt_1_form_extra_services" class="  nd_booking_width_100_percentage nd_booking_float_left nd_booking_padding_0_15 nd_booking_box_sizing_border_box">
            ...
            <div class="nd_booking_section nd_booking_position_relative nd_booking_padding_30 nd_booking_padding_30_15_all_iphone nd_booking_box_sizing_border_box">
                <h3>Zonas :</h3>
                <img class="nd_booking_toogle_additional_services_open_content nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="http://www.nicdarkthemes.com/themes/resort/wp/demo/apartment/wp-content/plugins/nd-booking/assets/img/icons/icon-down-arrow-grey.svg">
                <img style="transform: rotate(180deg);" class="nd_booking_toogle_additional_services_close_content nd_booking_display_none nd_booking_position_absolute nd_booking_right_30 nd_booking_top_35 nd_booking_cursor_pointer" alt="" width="12" src="http://www.nicdarkthemes.com/themes/resort/wp/demo/apartment/wp-content/plugins/nd-booking/assets/img/icons/icon-down-arrow-grey.svg">
            </div>
            ...
            <div class="nd_booking_toogle_additional_services_content nd_booking_padding_0_30 nd_booking_section nd_booking_display_none nd_booking_margin_top_10_negative nd_booking_box_sizing_border_box">
              ...
              if ( $taxonomies_zonas ) {
                foreach (  $taxonomies_zonas as $taxonomy ) {
                  ...
                  <input 
                  class="nd_booking_checkbox_additional_service nd_booking_width_25 nd_booking_margin_0 nd_booking_padding_0 nd_booking_margin_top_8" name="nd_booking_additional_service_id_' . $taxonomy->term_id . '" type="checkbox" value="$taxonomy->term_id,">
                    ' . $taxonomy->name . '
                  </p>
                  ';
                }
