...
add_action( 'servicios_add_form_fields', 'add_custom_taxonomy_image', 10, 2 );
...
add_action( 'servicios_edit_form_fields', 'update_custom_taxonomy_image', 10, 2 );
...
add_action( 'edited_servicios', 'updated_custom_taxonomy_image', 10, 2 );
...
function custom_taxonomy_load_media() {
    if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'servicios' ) {
       return;
    }
    wp_enqueue_media();
}
...
add_filter( 'manage_edit-servicios_columns', 'display_custom_taxonomy_image_column_heading' ); 
...
add_action( 'manage_servicios_custom_column', 'display_custom_taxonomy_image_column_value' , 10, 3); 
